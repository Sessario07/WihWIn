...
function generateUserCredentials(index) {
    ...
    return {
        username: `stress_user_${index}_${timestamp}_${random}`,
        email: `stress${index}_${timestamp}_${random}@example.com`,
        password: `StressPass123!${index}`,
        role: 'customer',
    };
}
...
export function setup() {
    ...
    if (users.length === 0) {
        throw new Error('No users registered successfully. Cannot proceed with stress test.');
    }
...
export function handleSummary(data) {
    ...
    console.log(`Test Type:              Stress Test (Beyond Normal Capacity)`);
    ...
    console.log('\nSPRING BOOT LOGIN ENDPOINT (STRESS):');
    console.log('-'.repeat(70));
    console.log(`  Target Peak RPS:      250`);
    ...
    console.log('\nFASTAPI BATCH TELEMETRY ENDPOINT (STRESS):');
    console.log('-'.repeat(70));
    console.log(`  Target Peak RPS:      500`);
